    ...
    <motion.div variants={stagger} initial="hidden" animate="show" className="space-y-6">
      ...
      <motion.div variants={fadeUp} className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        {[
          ...
          { icon: ListChecks, label: "Acoes", value: stats.totalAcoes, sub: `${(stats.totalAcoes / stats.total).toFixed(1)} por reuniao`, color: "from-emerald-500/10 to-emerald-600/5", iconColor: "text-emerald-500" },
